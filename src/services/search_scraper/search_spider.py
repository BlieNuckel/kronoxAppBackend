...
class SearchSpider(scrapy.Spider):
    ...
    def __init__(self, searchString: str, yearQuery: str, baseUrl: str):
        ...
        self.start_urls = [f"https://{self.baseUrl}/program.jsp"]
        super().__init__(self.name)

    def start_requests(self):
        return [
            scrapy.Request.from_curl(
                f"""curl "https://{self.baseUrl}/ajax/ajax_sokResurser.jsp?sokord={self.searchString}&startDatum=idag&slutDatum=&intervallTyp=m&intervallAntal=6"
